...
cmd:option('-network',            'Cifar10_Model.lua',            'Model file - must return valid network.')
...
cmd:option('-type',               'float',                 'cuda/cl/float/double')
cmd:option('-devid',              0,                      'device ID (if using CUDA)')
cmd:option('-nGPU',               0,                      'num of gpu devices used')
